...
Como sugiere el nombre, las presupuesto son una parte central del MoneyTrack. En esta página, profundizaremos en los diferentes puntos finales de usuario que puede utilizar para administrar los presupuestos mediante programación. Veremos cómo consultar, crear, actualizar y eliminar presupuestos. {{ className: 'lead' }}

## Modelo Presupuesto

El modelo de presupuesto contiene toda la información sobre sus categorias, como su id y nombre.
...
## Crear Categoria {{ tag: 'POST', label: '/presupuestos' }}
