...
<Row>
  <Col>
    ...
    En este ejemplo, solicitamos las transacciones de un usuario. Como resultado, obtenemos una lista de 1 transaccion y podemos saber por el atributo <code>total</code> <code>pages</code> <code>per_page</code> 
